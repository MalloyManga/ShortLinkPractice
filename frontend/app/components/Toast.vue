...
<template>
    <div class="fixed top-4 right-4 z-[9999] flex flex-col gap-2 max-w-sm">
        <TransitionGroup name="toast">
            <div v-for="toast in toasts" :key="toast.id" :class="getColorClass(toast.type)"
                class="glass-effect rounded-xl p-4 border-2 backdrop-blur-lg shadow-2xl flex items-start gap-3 min-w-[300px]">
