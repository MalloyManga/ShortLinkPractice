...
<template>
    <div class="w-full max-w-2xl mx-auto px-4">
        ...
        <div class="glass-effect rounded-3xl p-8 md:p-12 shadow-2xl">
            <!-- 未登录提示 -->
            <div v-if="!isLoggedIn" class="mb-6 p-4 rounded-xl bg-blue-500/10 border-2 border-blue-500/20 backdrop-blur-sm">
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                    </svg>
                    <div class="flex-1">
                        <p class="text-blue-400 text-sm">Please sign in to create and manage your short links. Click the "Sign In" button in the top right corner.</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="handleGetShortLink" class="space-y-6">
                ...
                <div class="flex gap-3 pt-4">
                    <button
                        type="submit"
                        :disabled="status === 'pending' || !linksData.origin_link"
                    ...
                    >
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-2">
                            <svg v-if="status === 'pending'" class="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
                    ...
                    <button
                        v-if="linksData.origin_link || linksData.code"
                        type="button"
                        @click="clearInputs"
            ...
            <!-- 成功提示 -->
            <Transition name="slide">
                <div v-if="showSuccess && data" class="mt-6 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-2 border-purple-500/20 backdrop-blur-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 p-3 bg-white/5 rounded-lg">
                                ...
                                <button 
                                    @click="() => { if (data) copyToClipboard(data.shortLink) }"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div class="glass-effect rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
                <div class="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
            ...
            <div class="glass-effect rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
                <div class="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="glass-effect rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
                <div class="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
